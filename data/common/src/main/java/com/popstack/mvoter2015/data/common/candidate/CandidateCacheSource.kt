...
interface CandidateCacheSource {
  ...
  fun putRivalCandidateList(candidateList: List<Candidate>, queryConstituencyId: ConstituencyId)
  ...
  fun getRivalCandidateList(constituencyId: ConstituencyId): List<Candidate>
